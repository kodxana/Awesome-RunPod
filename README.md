...
| [runpod-api]        | Python scripts for RunPod GraphQL API| [ashleykleynhans](https://github.com/ashleykleynhans) | ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-api?style=social) |

[runpodctl]: https://github.com/runpod/runpodctl
[runpod-python]: https://github.com/runpod/runpod-python
[runpod-api]: https://github.com/ashleykleynhans/runpod-api
...
| [ComfyUI] | ComfyUI | [ashleykleynhans] No Github Repo |
...
| [Fooocus] | Focus on prompting and generating | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/fooocus-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/fooocus-docker?style=social) |
| [hallo] | Hierarchical Audio-Driven Visual Synthesis for Portrait Image Animation | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/hallo-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/hallo-docker?style=social) |
| [InstantID] | Zero-shot Identity-Preserving Generation in Seconds | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/instantid-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/instantid-docker?style=social) |
...
| [Rerender a Video] | Rerender A Video: Zero-Shot Text-Guided Video-to-Video Translation | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/rerender-a-video-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/rerender-a-video-docker?style=social) |
| [Stable Audio Tools] | Stable Audio Tools: Generative models for conditional audio generation | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/stable-audio-tools-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/stable-audio-tools-docker?style=social) |
| [Stable Diffusion WebUI Forge] | Stable Diffusion Web UI Forge | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/forge-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/forge-docker?style=social) |
| [SUPIR Upscaling and Restoration] | SUPIR Upscaling and Restoration | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/supir-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/supir-docker?style=social) |
| [Text Generation Web UI and API] | Oobabooga Text Generation Web UI and API | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/text-generation-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/text-generation-docker?style=social) |
| [Text To Speech Generation Web UI] | Text To Speech Generation Web UI | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/tts-generation-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/tts-generation-docker?style=social) |
| [ULTIMATE Stable Diffusion Kohya ComfyUI InvokeAI] | A combined template for the AUTOMATIC1111 Web UI including the Dreambooth, ControlNet, ReActor, Deforum extensions; as well as Kohya_ss, ComfyUI and InvokeAI | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/stable-diffusion-docker) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/stable-diffusion-docker?style=social) |

[A1111 Stable Diffusion]: https://runpod.io/console/gpu-cloud?template=ts8ze6urzh&ref=2xxro4sy
...
[Rerender a Video]: https://runpod.io/gsc?template=hfucz07h1h&ref=2xxro4sy
[Stable Audio Tools]: https://runpod.io/console/deploy?template=xt220okdd1&ref=2xxro4sy
[Stable Diffusion WebUI Forge]: https://runpod.io/gsc?template=gpsiphjvvd&ref=2xxro4sy
[SUPIR Upscaling and Restoration]: https://runpod.io/console/gpu-cloud?template=aa31uo64wv&ref=2xxro4sy
[Text Generation Web UI and API]: https://runpod.io/gsc?template=el5m58e1to&ref=2xxro4sy
[Text To Speech Generation Web UI]: https://runpod.io/gsc?template=j898rhd8t6&ref=2xxro4sy
[ULTIMATE Stable Diffusion Kohya ComfyUI InvokeAI]: https://runpod.io/gsc?template=ya6013lj5a&ref=2xxro4sy
...
|--------|-------------|--------|------------|
| [A1111 Worker] | Automatic1111 Serverless Worker that leverages using a Network volume for storing models | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-a1111) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-a1111?style=social) |
...
| [ExLlama Worker] | RunPod Serverless Worker for Text Generation Inference and Streaming using ExLlama | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/exllama-runpod-serverless) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/exllama-runpod-serverless?style=social) |
| [ExLlamaV2 Worker] | RunPod Serverless Worker for Text Generation Inference and Streaming using ExLlamaV2 | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-exllamav2) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-exllamav2?style=social) |
| [Face Swap Worker] | RunPod Serverless Worker for Face Swapping and Restoration powered by Insightface | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-inswapper) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-inswapper?style=social) |
| [Forge Worker] | RunPod Serverless Worker for Stable Diffusion WebUI Forge | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-forge) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-forge?style=social) |
| [InstantID Worker] | RunPod Serverless Worker for InstantID : Zero-shot Identity-Preserving Generation in Seconds | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-instantid) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-instantid?style=social) |
...
| [Oobabooga Text Generation Worker] | RunPod Serverless Worker for Oobabooga Text Generation API for LLMs | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-oobabooga) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-oobabooga?style=social) |
| [Real-ESRGAN Upscaling Worker] | RunPod Serverless Worker for Real-ESRGAN Restoration and Upscaling | [ashleykleynhans] | [![GitHub Repo](https://img.shields.io/badge/Repo-Github-brightgreen?style=flat-square&logo=github)](https://github.com/ashleykleynhans/runpod-worker-real-esrgan) ![GitHub stars](https://img.shields.io/github/stars/ashleykleynhans/runpod-worker-real-esrgan?style=social) |
...
[A1111 Worker]: https://github.com/ashleykleynhans/runpod-worker-a1111
...
[ExLlama Worker]: https://github.com/ashleykleynhans/exllama-runpod-serverless
[ExLlamaV2 Worker]: https://github.com/ashleykleynhans/runpod-worker-exllamav2
[Face Swap Worker]: https://github.com/ashleykleynhans/runpod-worker-inswapper
[Forge Worker]: https://github.com/ashleykleynhans/runpod-worker-forge
[InstantID Worker]: https://github.com/ashleykleynhans/runpod-worker-instantid
[Kandinsky Worker]: https://github.com/runpod-workers/worker-kandinsky
[Oobabooga Text Generation Worker]: https://github.com/ashleykleynhans/runpod-worker-oobabooga
[Real-ESRGAN Upscaling Worker]: https://github.com/ashleykleynhans/runpod-worker-real-esrgan
